...
const NavList = ({navbarOpen}) => {
  return (
    <ul className={`${navbarOpen ? 'block absolute right-0 top-20' : 'hidden'}`}>
      <li>
        <Link to='/' className='flex items-center justify-center gap-2 border border-gray-200 px-12 py-4 hover:bg-gray-100 transition dark:bg-zinc-800 dark:border-gray-700 dark:hover:bg-zinc-600'>
      ...
      <li>
        <Link to='/contacts' className='flex items-center justify-center gap-2 border border-gray-200 px-12 py-4 hover:bg-gray-100 transition dark:bg-zinc-800 dark:hover:bg-zinc-600 dark:border-gray-700'>
