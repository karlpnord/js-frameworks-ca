              ...
              <div className='flex-1 flex flex-col'>
                ...
                <div className='flex justify-between'>
                  <div className='flex items-center justify-between text-md px-2'>
                    <button className='bg-gray-100 dark:bg-zinc-900 rounded-md p-1' onClick={() => onIncrement(item)}>
                      <FaPlus className='cursor-pointer dark:text-gray-200'/>
                    </button>
                    <span className='px-2 font-semibold dark:text-gray-200'>{item.quantity}</span>
                    <button className='bg-gray-100 dark:bg-zinc-900 rounded-md p-1' onClick={() => onDecrement(item)}>
                      <FaMinus className='cursor-pointer dark:text-gray-200'/>
                    </button>
                  </div>
